...
@EventBusSubscriber
public class ToxicBiomeFruitDecorator extends CocoaDecorator {
	public static MapCodec<ToxicBiomeFruitDecorator> CODEC = MapCodec.unit(ToxicBiomeFruitDecorator::new);
	public static TreeDecoratorType<?> DECORATOR_TYPE = new TreeDecoratorType<>(CODEC);

	@SubscribeEvent
	public static void registerTreeDecorator(RegisterEvent event) {
		event.register(Registries.TREE_DECORATOR_TYPE, ResourceLocation.parse("mythicrealms:toxic_biome_tree_fruit_decorator"), () -> DECORATOR_TYPE);
	}

	public ToxicBiomeFruitDecorator() {
		super(0.2f);
	}
