...
@EventBusSubscriber
public class ToxicBiomeTrunkDecorator extends TrunkVineDecorator {
	public static MapCodec<ToxicBiomeTrunkDecorator> CODEC = MapCodec.unit(ToxicBiomeTrunkDecorator::new);
	public static TreeDecoratorType<?> DECORATOR_TYPE = new TreeDecoratorType<>(CODEC);

	@SubscribeEvent
	public static void registerTreeDecorator(RegisterEvent event) {
		event.register(Registries.TREE_DECORATOR_TYPE, ResourceLocation.parse("mythicrealms:toxic_biome_tree_trunk_decorator"), () -> DECORATOR_TYPE);
	}
