package net.mcreator.mythicrealms.world.features.treedecorators;
...
@EventBusSubscriber
public class MagneticCaveLeaveDecorator extends LeaveVineDecorator {
	public static MapCodec<MagneticCaveLeaveDecorator> CODEC = MapCodec.unit(MagneticCaveLeaveDecorator::new);
	public static TreeDecoratorType<?> DECORATOR_TYPE = new TreeDecoratorType<>(CODEC);

	@SubscribeEvent
	public static void registerTreeDecorator(RegisterEvent event) {
		event.register(Registries.TREE_DECORATOR_TYPE, ResourceLocation.parse("mythicrealms:magnetic_cave_tree_leave_decorator"), () -> DECORATOR_TYPE);
	}

	public MagneticCaveLeaveDecorator() {
		super(0.25f);
	}
