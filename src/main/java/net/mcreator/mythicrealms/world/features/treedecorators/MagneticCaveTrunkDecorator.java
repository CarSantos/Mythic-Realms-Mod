...
@EventBusSubscriber
public class MagneticCaveTrunkDecorator extends TrunkVineDecorator {
	public static MapCodec<MagneticCaveTrunkDecorator> CODEC = MapCodec.unit(MagneticCaveTrunkDecorator::new);
	public static TreeDecoratorType<?> DECORATOR_TYPE = new TreeDecoratorType<>(CODEC);

	@SubscribeEvent
	public static void registerTreeDecorator(RegisterEvent event) {
		event.register(Registries.TREE_DECORATOR_TYPE, ResourceLocation.parse("mythicrealms:magnetic_cave_tree_trunk_decorator"), () -> DECORATOR_TYPE);
	}
