...
@EventBusSubscriber
public class ToxicBiomeLeaveDecorator extends LeaveVineDecorator {
	public static MapCodec<ToxicBiomeLeaveDecorator> CODEC = MapCodec.unit(ToxicBiomeLeaveDecorator::new);
	public static TreeDecoratorType<?> DECORATOR_TYPE = new TreeDecoratorType<>(CODEC);

	@SubscribeEvent
	public static void registerTreeDecorator(RegisterEvent event) {
		event.register(Registries.TREE_DECORATOR_TYPE, ResourceLocation.parse("mythicrealms:toxic_biome_tree_leave_decorator"), () -> DECORATOR_TYPE);
	}

	public ToxicBiomeLeaveDecorator() {
		super(0.25f);
	}
