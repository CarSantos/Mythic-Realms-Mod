...
@EventBusSubscriber
public class MagneticCaveFruitDecorator extends CocoaDecorator {
	public static MapCodec<MagneticCaveFruitDecorator> CODEC = MapCodec.unit(MagneticCaveFruitDecorator::new);
	public static TreeDecoratorType<?> DECORATOR_TYPE = new TreeDecoratorType<>(CODEC);

	@SubscribeEvent
	public static void registerTreeDecorator(RegisterEvent event) {
		event.register(Registries.TREE_DECORATOR_TYPE, ResourceLocation.parse("mythicrealms:magnetic_cave_tree_fruit_decorator"), () -> DECORATOR_TYPE);
	}

	public MagneticCaveFruitDecorator() {
		super(0.2f);
	}
