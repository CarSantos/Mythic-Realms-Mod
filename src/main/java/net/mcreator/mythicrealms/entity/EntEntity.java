...
import net.mcreator.mythicrealms.procedures.EntEntityDiesProcedure;
...
public class EntEntity extends Monster {
	...
	public static final EntityDataAccessor<Integer> ANIM = SynchedEntityData.defineId(EntEntity.class, EntityDataSerializers.INT);
	...
	public void die(DamageSource source) {
		super.die(source);
		EntEntityDiesProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ());
	}
	...
	public void readAdditionalSaveData(ValueInput valueInput) {
		...
		this.setTexture(valueInput.getStringOr("Texture", "ent"));
	}
	...
	public static void init(RegisterSpawnPlacementsEvent event) {
		event.register(MythicrealmsModEntities.ENT.get(), SpawnPlacementTypes.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
