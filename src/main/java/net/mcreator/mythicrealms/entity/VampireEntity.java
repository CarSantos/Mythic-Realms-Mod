...
import net.mcreator.mythicrealms.procedures.VampireItIsStruckByLightningProcedure;
...
public class VampireEntity extends Monster {
	...
	public static final EntityDataAccessor<Integer> ANIM = SynchedEntityData.defineId(VampireEntity.class, EntityDataSerializers.INT);
	...
	public void thunderHit(ServerLevel serverWorld, LightningBolt lightningBolt) {
		...
		VampireItIsStruckByLightningProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
	}
	...
	public void readAdditionalSaveData(ValueInput valueInput) {
		...
		this.setTexture(valueInput.getStringOr("Texture", "vampire"));
	}
	...
	public static void init(RegisterSpawnPlacementsEvent event) {
		event.register(MythicrealmsModEntities.VAMPIRE.get(), SpawnPlacementTypes.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
