...
import net.mcreator.mythicrealms.procedures.PumpkinProjectileProjectileHitsliveProcedure;
import net.mcreator.mythicrealms.procedures.PumpkinProjectileProjectileHitsBlockProcedure;
import net.mcreator.mythicrealms.init.MythicrealmsModEntities;

import javax.annotation.Nullable;

public class PumpkinProjectileEntity extends AbstractArrow implements ItemSupplier {
	public static final ItemStack PROJECTILE_ITEM = new ItemStack(Blocks.CARVED_PUMPKIN);
	private int knockback = 0;

	public PumpkinProjectileEntity(EntityType<? extends PumpkinProjectileEntity> type, Level world) {
		super(type, world);
		setNoGravity(true);
	}

	public PumpkinProjectileEntity(EntityType<? extends PumpkinProjectileEntity> type, double x, double y, double z, Level world, @Nullable ItemStack firedFromWeapon) {
	...
	public PumpkinProjectileEntity(EntityType<? extends PumpkinProjectileEntity> type, LivingEntity entity, Level world, @Nullable ItemStack firedFromWeapon) {
	...
	public void playerTouch(Player entity) {
		...
		PumpkinProjectileProjectileHitsliveProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), entity, this.getOwner());
	}

	@Override
	public void onHitEntity(EntityHitResult entityHitResult) {
		super.onHitEntity(entityHitResult);
		PumpkinProjectileProjectileHitsliveProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), entityHitResult.getEntity(), this.getOwner());
	}

	@Override
	public void onHitBlock(BlockHitResult blockHitResult) {
		super.onHitBlock(blockHitResult);
		PumpkinProjectileProjectileHitsBlockProcedure.execute(this.level(), blockHitResult.getBlockPos().getX(), blockHitResult.getBlockPos().getY(), blockHitResult.getBlockPos().getZ());
	}
	...
	public static PumpkinProjectileEntity shoot(Level world, LivingEntity entity, RandomSource source) {
		return shoot(world, entity, source, 1f, 0, 0);
	}

	public static PumpkinProjectileEntity shoot(Level world, LivingEntity entity, RandomSource source, float pullingPower) {
		return shoot(world, entity, source, pullingPower * 1f, 0, 0);
	}

	public static PumpkinProjectileEntity shoot(Level world, LivingEntity entity, RandomSource random, float power, double damage, int knockback) {
		PumpkinProjectileEntity entityarrow = new PumpkinProjectileEntity(MythicrealmsModEntities.PUMPKIN_PROJECTILE.get(), entity, world, null);
	...
	public static PumpkinProjectileEntity shoot(LivingEntity entity, LivingEntity target) {
		PumpkinProjectileEntity entityarrow = new PumpkinProjectileEntity(MythicrealmsModEntities.PUMPKIN_PROJECTILE.get(), entity, entity.level(), null);
