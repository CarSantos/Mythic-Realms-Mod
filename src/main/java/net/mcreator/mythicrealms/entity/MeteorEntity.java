...
import net.mcreator.mythicrealms.procedures.MeteorProjectileHitsProcedure;
import net.mcreator.mythicrealms.init.MythicrealmsModEntities;

import javax.annotation.Nullable;

public class MeteorEntity extends AbstractArrow implements ItemSupplier {
	public static final ItemStack PROJECTILE_ITEM = new ItemStack(Blocks.MAGMA_BLOCK);
	private int knockback = 0;

	public MeteorEntity(EntityType<? extends MeteorEntity> type, Level world) {
		super(type, world);
	}

	public MeteorEntity(EntityType<? extends MeteorEntity> type, double x, double y, double z, Level world, @Nullable ItemStack firedFromWeapon) {
	...
	public MeteorEntity(EntityType<? extends MeteorEntity> type, LivingEntity entity, Level world, @Nullable ItemStack firedFromWeapon) {
	...
	public void playerTouch(Player entity) {
		...
		MeteorProjectileHitsProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ());
	}
	...
	public void onHitBlock(BlockHitResult blockHitResult) {
		...
		MeteorProjectileHitsProcedure.execute(this.level(), blockHitResult.getBlockPos().getX(), blockHitResult.getBlockPos().getY(), blockHitResult.getBlockPos().getZ());
	}
	...
	public static MeteorEntity shoot(Level world, LivingEntity entity, RandomSource source) {
		return shoot(world, entity, source, 1f, 5, 5);
	}

	public static MeteorEntity shoot(Level world, LivingEntity entity, RandomSource source, float pullingPower) {
		return shoot(world, entity, source, pullingPower * 1f, 5, 5);
	}

	public static MeteorEntity shoot(Level world, LivingEntity entity, RandomSource random, float power, double damage, int knockback) {
		MeteorEntity entityarrow = new MeteorEntity(MythicrealmsModEntities.METEOR.get(), entity, world, null);
	...
	public static MeteorEntity shoot(LivingEntity entity, LivingEntity target) {
		MeteorEntity entityarrow = new MeteorEntity(MythicrealmsModEntities.METEOR.get(), entity, entity.level(), null);
