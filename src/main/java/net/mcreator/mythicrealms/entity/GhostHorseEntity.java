...
public class GhostHorseEntity extends TamableAnimal {

	public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.defineId(GhostHorseEntity.class, EntityDataSerializers.STRING);
	public static final EntityDataAccessor<Integer> ANIM = SynchedEntityData.defineId(GhostHorseEntity.class, EntityDataSerializers.INT);
	public static final EntityDataAccessor<Boolean> DATA_hurt = SynchedEntityData.defineId(GhostHorseEntity.class, EntityDataSerializers.BOOLEAN);
	public final AnimationState animationState0 = new AnimationState();
	public final AnimationState animationState1 = new AnimationState();
	public final AnimationState animationState2 = new AnimationState();

	public GhostHorseEntity(EntityType<GhostHorseEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	}
	...
	protected void defineSynchedData(SynchedEntityData.Builder builder) {
		...
		builder.define(TEXTURE, "ghosthorse");
	...
	public SpawnGroupData finalizeSpawn(ServerLevelAccessor world, DifficultyInstance difficulty, EntitySpawnReason reason, @Nullable SpawnGroupData livingdata) {
		...
		GhostHorseOnInitialEntitySpawnProcedure.execute(this);
		return retval;
	}
	...
	public void readAdditionalSaveData(ValueInput valueInput) {
		...
		this.setTexture(valueInput.getStringOr("Texture", "ghosthorse"));
	...
	public AgeableMob getBreedOffspring(ServerLevel serverWorld, AgeableMob ageable) {
		GhostHorseEntity retval = MythicrealmsModEntities.GHOST_HORSE.get().create(serverWorld, EntitySpawnReason.BREEDING);
