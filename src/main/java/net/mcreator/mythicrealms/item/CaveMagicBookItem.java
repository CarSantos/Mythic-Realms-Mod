...
public class CaveMagicBookItem extends Item {
	public CaveMagicBookItem(Item.Properties properties) {
	...
	public void appendHoverText(ItemStack itemstack, Item.TooltipContext context, TooltipDisplay tooltipDisplay, Consumer<Component> componentConsumer, TooltipFlag flag) {
		...
		componentConsumer.accept(Component.translatable("item.mythicrealms.cave_magic_book.description_0"));
	}
