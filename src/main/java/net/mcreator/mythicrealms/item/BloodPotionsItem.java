...
import net.mcreator.mythicrealms.procedures.BloodPotionsEveryTickWhileUsingItemProcedure;

public class BloodPotionsItem extends Item {
	public BloodPotionsItem(Item.Properties properties) {
	...
	public void onUseTick(Level world, LivingEntity entity, ItemStack itemstack, int time) {
		BloodPotionsEveryTickWhileUsingItemProcedure.execute(entity);
	}
}