...
public class WaterBreathMagicBookItem extends Item {
	public WaterBreathMagicBookItem(Item.Properties properties) {
	...
	public void appendHoverText(ItemStack itemstack, Item.TooltipContext context, TooltipDisplay tooltipDisplay, Consumer<Component> componentConsumer, TooltipFlag flag) {
		...
		componentConsumer.accept(Component.translatable("item.mythicrealms.water_breath_magic_book.description_0"));
	}
