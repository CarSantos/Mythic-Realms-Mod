...
import net.mcreator.mythicrealms.procedures.SubstituteMagicProcedure;

import java.util.function.Consumer;

public class SubstituteMagicBookItem extends Item {
	public SubstituteMagicBookItem(Item.Properties properties) {
	...
	public void appendHoverText(ItemStack itemstack, Item.TooltipContext context, TooltipDisplay tooltipDisplay, Consumer<Component> componentConsumer, TooltipFlag flag) {
		...
		componentConsumer.accept(Component.translatable("item.mythicrealms.substitute_magic_book.description_0"));
	}
