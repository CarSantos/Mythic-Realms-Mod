...
public class SpectateMagicBookItem extends Item {
	public SpectateMagicBookItem(Item.Properties properties) {
	...
	public void appendHoverText(ItemStack itemstack, Item.TooltipContext context, TooltipDisplay tooltipDisplay, Consumer<Component> componentConsumer, TooltipFlag flag) {
		...
		componentConsumer.accept(Component.translatable("item.mythicrealms.spectate_magic_book.description_0"));
	}
