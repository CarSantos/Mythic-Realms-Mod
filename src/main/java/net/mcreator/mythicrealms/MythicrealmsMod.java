package net.mcreator.mythicrealms;
...
import net.mcreator.mythicrealms.init.*;
...
@Mod("mythicrealms")
public class MythicrealmsMod {
	public static final Logger LOGGER = LogManager.getLogger(MythicrealmsMod.class);
	public static final String MODID = "mythicrealms";

	public MythicrealmsMod(IEventBus modEventBus) {
		// Start of user code block mod constructor
		// End of user code block mod constructor
		NeoForge.EVENT_BUS.register(this);
		modEventBus.addListener(this::registerNetworking);
		if (ModList.get().isLoaded("curios")) {
			modEventBus.addListener(MythicrealmsModCuriosCompat::registerCapabilities);
		...
		MythicrealmsModVariables.ATTACHMENT_TYPES.register(modEventBus);
