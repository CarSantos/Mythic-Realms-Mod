...
public class ZombieVisualProcedure {
	@SubscribeEvent
	...
	private static void execute(@Nullable Event event, Entity entity, EntityModel entityModel, RenderPlayerEvent playerRenderEvent) {
		if (entity == null || entityModel == null || playerRenderEvent == null)
			return;
		if (entity instanceof LivingEntity _livEnt0 && _livEnt0.hasEffect(MythicrealmsModMobEffects.ZOMBIE)) {
			{
				ResourceLocation texture = (ResourceLocation.fromNamespaceAndPath("mythicrealms", "textures/entities/zombie_form.png"));
