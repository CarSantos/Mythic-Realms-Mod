...
public class LobisomenVisualProcedure {
	...
	private static void execute(@Nullable Event event, LevelAccessor world, Entity entity, RenderPlayerEvent playerRenderEvent) {
		if (entity == null || playerRenderEvent == null)
			return;
		if (entity instanceof LivingEntity _livEnt0 && _livEnt0.hasEffect(MythicrealmsModMobEffects.LOBISOMEN_EFFECT) && (world instanceof Level _lvl1 && _lvl1.isBrightOutside()) == false && world.dimensionType().moonPhase(world.dayTime()) == 0) {
			{
