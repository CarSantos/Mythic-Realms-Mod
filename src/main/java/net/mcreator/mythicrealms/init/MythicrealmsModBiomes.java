...
@EventBusSubscriber
public class MythicrealmsModBiomes {
	@SubscribeEvent
		...
		for (LevelStem levelStem : levelStemTypeRegistry.stream().toList()) {
			...
			if (dimensionType.is(BuiltinDimensionTypes.OVERWORLD)) {
				...
				if (chunkGenerator instanceof NoiseBasedChunkGenerator noiseGenerator) {
					((MythicrealmsModNoiseGeneratorSettings) (Object) noiseGenerator.settings.value()).setmythicrealmsDimensionTypeReference(dimensionType);
				}
			}
		}
	}
	...
	private static SurfaceRules.RuleSource injectOverworldSurfaceRules(SurfaceRules.RuleSource currentRuleSource) {
		...
		customSurfaceRules.add(anySurfaceRule(ResourceKey.create(Registries.BIOME, ResourceLocation.fromNamespaceAndPath("mythicrealms", "magnetic_cave")), MythicrealmsModBlocks.MAGNETIC_ROCK.get().defaultBlockState(),
				MythicrealmsModBlocks.ANTI_MAGNETIC_ROCK.get().defaultBlockState(), MythicrealmsModBlocks.ANTI_MAGNETIC_ROCK.get().defaultBlockState()));
		customSurfaceRules.add(preliminarySurfaceRule(ResourceKey.create(Registries.BIOME, ResourceLocation.fromNamespaceAndPath("mythicrealms", "darkness_plains")), Blocks.GRASS_BLOCK.defaultBlockState(), Blocks.DIRT.defaultBlockState(),
				Blocks.GRAVEL.defaultBlockState()));
		customSurfaceRules.add(preliminarySurfaceRule(ResourceKey.create(Registries.BIOME, ResourceLocation.fromNamespaceAndPath("mythicrealms", "darkness_forest")), Blocks.GRASS_BLOCK.defaultBlockState(), Blocks.DIRT.defaultBlockState(),
				Blocks.GRAVEL.defaultBlockState()));
		customSurfaceRules.add(preliminarySurfaceRule(ResourceKey.create(Registries.BIOME, ResourceLocation.fromNamespaceAndPath("mythicrealms", "mythic_forest")), Blocks.GRASS_BLOCK.defaultBlockState(), Blocks.DIRT.defaultBlockState(),
				Blocks.GRAVEL.defaultBlockState()));
		customSurfaceRules.add(preliminarySurfaceRule(ResourceKey.create(Registries.BIOME, ResourceLocation.fromNamespaceAndPath("mythicrealms", "desert_of_dead_star")), MythicrealmsModBlocks.SAND_OF_STAR.get().defaultBlockState(),
				Blocks.STONE.defaultBlockState(), Blocks.GRAVEL.defaultBlockState()));
		customSurfaceRules.add(preliminarySurfaceRule(ResourceKey.create(Registries.BIOME, ResourceLocation.fromNamespaceAndPath("mythicrealms", "toxic_biome")), MythicrealmsModBlocks.TOXIC_SAND.get().defaultBlockState(),
				Blocks.OBSIDIAN.defaultBlockState(), Blocks.CRYING_OBSIDIAN.defaultBlockState()));
	...
	public interface MythicrealmsModNoiseGeneratorSettings {
		void setmythicrealmsDimensionTypeReference(Holder<DimensionType> dimensionType);
	}
}