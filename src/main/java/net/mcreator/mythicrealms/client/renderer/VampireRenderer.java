...
import net.mcreator.mythicrealms.entity.VampireEntity;
import net.mcreator.mythicrealms.client.model.animations.VampireAnimation;
import net.mcreator.mythicrealms.client.model.ModelVampire;
...
public class VampireRenderer extends MobRenderer<VampireEntity, LivingEntityRenderState, ModelVampire> {
	...
	public ResourceLocation getTextureLocation(LivingEntityRenderState state) {
		...
		return ResourceLocation.parse("mythicrealms:textures/entities/vampire.png");
	}
	...
	private static final class AnimatedModel extends ModelVampire {
		...
		public AnimatedModel(ModelPart root) {
			super(root);
			this.keyframeAnimation0 = VampireAnimation.idle.bake(root);
			this.keyframeAnimation1 = VampireAnimation.walk.bake(root);
		}
