...
import net.mcreator.mythicrealms.client.model.ModelWendigo_Armor;

import java.util.Map;
import java.util.Collections;

@EventBusSubscriber(Dist.CLIENT)
public class WendigoArmorArmorArmor {
	@SubscribeEvent
	public static void registerItemExtensions(RegisterClientExtensionsEvent event) {
		event.registerItem(new IClientItemExtensions() {
				...
				if (armorModel == null) {
					armorModel = new HumanoidModel(new ModelPart(Collections.emptyList(), Map.of("head",
							new ModelPart(Collections.emptyList(),
									Map.of("head", new ModelWendigo_Armor(Minecraft.getInstance().getEntityModels().bakeLayer(ModelWendigo_Armor.LAYER_LOCATION)).Helmet, "hat", new ModelPart(Collections.emptyList(), Collections.emptyMap()))),
			...
			public ResourceLocation getArmorTexture(ItemStack stack, EquipmentClientInfo.LayerType type, EquipmentClientInfo.Layer layer, ResourceLocation _default) {
				return ResourceLocation.parse("mythicrealms:textures/entities/wendigo_armor.png");
			}
		}, MythicrealmsModItems.WENDIGO_ARMOR_ARMOR_HELMET.get());
		event.registerItem(new IClientItemExtensions() {
			private HumanoidModel armorModel = null;
			...
			public HumanoidModel getHumanoidArmorModel(ItemStack itemStack, EquipmentClientInfo.LayerType layerType, Model original) {
				if (armorModel == null) {
					ModelWendigo_Armor model = new ModelWendigo_Armor(Minecraft.getInstance().getEntityModels().bakeLayer(ModelWendigo_Armor.LAYER_LOCATION));
		...
		}, MythicrealmsModItems.WENDIGO_ARMOR_ARMOR_CHESTPLATE.get());
		event.registerItem(new IClientItemExtensions() {
			private HumanoidModel armorModel = null;
		...
		}, MythicrealmsModItems.WENDIGO_ARMOR_ARMOR_LEGGINGS.get());
		event.registerItem(new IClientItemExtensions() {
			private HumanoidModel armorModel = null;
		...
		}, MythicrealmsModItems.WENDIGO_ARMOR_ARMOR_BOOTS.get());
	}
}