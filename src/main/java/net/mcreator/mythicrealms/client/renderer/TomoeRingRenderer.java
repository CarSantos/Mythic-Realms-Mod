...
import net.mcreator.mythicrealms.client.model.ModelTomoe_Ring;
...
public class TomoeRingRenderer implements ICurioRenderer.HumanoidRender {
	private static final ResourceLocation TEXTURE = ResourceLocation.parse("mythicrealms:textures/entities/tomoe_ring.png");
	private final HumanoidModel humanoidModel;

	public TomoeRingRenderer() {
		ModelTomoe_Ring model = new ModelTomoe_Ring(Minecraft.getInstance().getEntityModels().bakeLayer(ModelTomoe_Ring.LAYER_LOCATION));
