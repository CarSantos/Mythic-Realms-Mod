...
import net.mcreator.mythicrealms.client.model.ModelMagnet_Armor;
	...
	public static void registerItemExtensions(RegisterClientExtensionsEvent event) {
		event.registerItem(new IClientItemExtensions() {
				...
				if (armorModel == null) {
					armorModel = new HumanoidModel(new ModelPart(Collections.emptyList(), Map.of("head",
							new ModelPart(Collections.emptyList(),
									Map.of("head", new ModelMagnet_Armor(Minecraft.getInstance().getEntityModels().bakeLayer(ModelMagnet_Armor.LAYER_LOCATION)).Helmet, "hat", new ModelPart(Collections.emptyList(), Collections.emptyMap()))),
			...
			public ResourceLocation getArmorTexture(ItemStack stack, EquipmentClientInfo.LayerType type, EquipmentClientInfo.Layer layer, ResourceLocation _default) {
				return ResourceLocation.parse("mythicrealms:textures/entities/magnet_armor.png");
			}
		}, MythicrealmsModItems.MAGNET_ARMOR_HELMET.get());
		event.registerItem(new IClientItemExtensions() {
			private HumanoidModel armorModel = null;
			...
			public HumanoidModel getHumanoidArmorModel(ItemStack itemStack, EquipmentClientInfo.LayerType layerType, Model original) {
				if (armorModel == null) {
					ModelMagnet_Armor model = new ModelMagnet_Armor(Minecraft.getInstance().getEntityModels().bakeLayer(ModelMagnet_Armor.LAYER_LOCATION));
		...
		}, MythicrealmsModItems.MAGNET_ARMOR_CHESTPLATE.get());
		event.registerItem(new IClientItemExtensions() {
			private HumanoidModel armorModel = null;
		...
		}, MythicrealmsModItems.MAGNET_ARMOR_LEGGINGS.get());
		event.registerItem(new IClientItemExtensions() {
			private HumanoidModel armorModel = null;
		...
		}, MythicrealmsModItems.MAGNET_ARMOR_BOOTS.get());
	}
}