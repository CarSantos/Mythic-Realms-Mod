...
import net.mcreator.mythicrealms.client.model.ModelMagnet_Propulsor;
...
public class MagnetPropulsorRenderer implements ICurioRenderer.HumanoidRender {
	private static final ResourceLocation TEXTURE = ResourceLocation.parse("mythicrealms:textures/entities/magnet_propulsor.png");
	private final HumanoidModel humanoidModel;

	public MagnetPropulsorRenderer() {
		ModelMagnet_Propulsor model = new ModelMagnet_Propulsor(Minecraft.getInstance().getEntityModels().bakeLayer(ModelMagnet_Propulsor.LAYER_LOCATION));
		this.humanoidModel = new HumanoidModel(new ModelPart(Collections.emptyList(),
				Map.of("head", new ModelPart(Collections.emptyList(), Map.of("head", new ModelPart(Collections.emptyList(), Collections.emptyMap()), "hat", new ModelPart(Collections.emptyList(), Collections.emptyMap()))), "body", model.Chestplate,
