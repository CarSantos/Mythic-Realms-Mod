...
import net.mcreator.mythicrealms.entity.BlackHoleProjectileEntity;
...
public class BlackHoleProjectileRenderer extends EntityRenderer<BlackHoleProjectileEntity, LivingEntityRenderState> {
	private static final ResourceLocation texture = ResourceLocation.parse("mythicrealms:textures/entities/blackhole.png");
	private final ModelBlackHole model;

	public BlackHoleProjectileRenderer(EntityRendererProvider.Context context) {
		super(context);
		model = new ModelBlackHole(context.bakeLayer(ModelBlackHole.LAYER_LOCATION));
	}
	...
	@Override
	public void extractRenderState(BlackHoleProjectileEntity entity, LivingEntityRenderState state, float partialTicks) {
