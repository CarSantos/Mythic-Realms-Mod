...
import net.mcreator.mythicrealms.client.model.ModelChimera_Gun;
...
public class ChimeraGunRenderer implements ICurioRenderer.HumanoidRender {
	private static final ResourceLocation TEXTURE = ResourceLocation.parse("mythicrealms:textures/entities/chimera_gun.png");
	private final HumanoidModel humanoidModel;

	public ChimeraGunRenderer() {
		ModelChimera_Gun model = new ModelChimera_Gun(Minecraft.getInstance().getEntityModels().bakeLayer(ModelChimera_Gun.LAYER_LOCATION));
