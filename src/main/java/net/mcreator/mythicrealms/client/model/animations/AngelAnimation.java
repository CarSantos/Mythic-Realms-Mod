	...
	public static final AnimationDefinition Fly = AnimationDefinition.Builder.withLength(1.0F).looping()
			...
			.addAnimation("spin",
					new AnimationChannel(AnimationChannel.Targets.POSITION, new Keyframe(0.0F, KeyframeAnimations.posVec(0.0F, 1.122F, 0.8609F), AnimationChannel.Interpolations.LINEAR),
							new Keyframe(0.5F, KeyframeAnimations.posVec(0.0F, -0.002F, -0.0009F), AnimationChannel.Interpolations.LINEAR), new Keyframe(1.0F, KeyframeAnimations.posVec(0.0F, 1.122F, 0.8609F), AnimationChannel.Interpolations.LINEAR)))
			.addAnimation("ala",
					new AnimationChannel(AnimationChannel.Targets.ROTATION, new Keyframe(0.0F, KeyframeAnimations.degreeVec(0.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.LINEAR),
							new Keyframe(0.5417F, KeyframeAnimations.degreeVec(-2.4884F, -32.1734F, 6.2233F), AnimationChannel.Interpolations.LINEAR),
							new Keyframe(0.9167F, KeyframeAnimations.degreeVec(-0.9934F, 29.7224F, -3.7377F), AnimationChannel.Interpolations.LINEAR),
