...
import net.mcreator.mythicrealms.network.LoadPlayerAnimationMessage;
...
public class MythicrealmsModPlayerAnimationAPI {
	...
	private static class AnimationLoader {
		...
		public static void loadAnimations(PlayerEvent.PlayerLoggedInEvent event) {
			if (MythicrealmsModPlayerAnimationAPI.initialized.get(event.getEntity().getUUID()) == null) {
				if (event.getEntity() instanceof ServerPlayer player) {
					...
					MythicrealmsModPlayerAnimationAPI.initialized.put(player.getUUID(), true);
				}
			}
		}
