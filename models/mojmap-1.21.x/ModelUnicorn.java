...
public class ModelUnicorn<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "unicorn"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Leg1A = partdefinition.addOrReplaceChild("Leg1A",
				CubeListBuilder.create().texOffs(0, 51)
						.addBox(-2.0F, 0.0F, -2.0F, 4.0F, 11.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(64, 18)
		...
		PartDefinition Leg2A = partdefinition.addOrReplaceChild("Leg2A",
				CubeListBuilder.create().texOffs(54, 32)
						.addBox(-2.0F, 0.0F, -2.0F, 4.0F, 11.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(0, 66)
						.addBox(-2.0F, 7.0F, -2.0F, 4.0F, 4.0F, 4.0F, new CubeDeformation(0.3F)),
				PartPose.offset(-3.0F, 13.0F, 9.0F));

		PartDefinition Leg3A = partdefinition.addOrReplaceChild("Leg3A",
				CubeListBuilder.create().texOffs(54, 47)
						.addBox(-2.0F, 0.0F, -2.0F, 4.0F, 11.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(32, 70)
		...
		PartDefinition Leg4A = partdefinition.addOrReplaceChild("Leg4A",
				CubeListBuilder.create().texOffs(16, 61)
						.addBox(-2.0F, 0.0F, -2.0F, 4.0F, 11.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(70, 26)
						.addBox(-2.0F, 8.0F, -2.0F, 4.0F, 3.0F, 4.0F, new CubeDeformation(0.3F)),
				PartPose.offset(-3.0F, 13.0F, -9.0F));

		PartDefinition Head = partdefinition.addOrReplaceChild("Head",
				CubeListBuilder.create().texOffs(52, 62)
						.addBox(-2.0F, -5.0F, -11.0F, 4.0F, 4.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(22, 32)
						.addBox(-3.0F, -5.0F, -6.0F, 6.0F, 5.0F, 7.0F, new CubeDeformation(0.1F)).texOffs(70, 40)
						.addBox(-1.0F, -7.0F, -5.0F, 2.0F, 6.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(70, 48)
						.addBox(-1.0F, -11.0F, -5.0F, 2.0F, 6.0F, 2.0F, new CubeDeformation(-0.2F)),
				PartPose.offsetAndRotation(0.0F, -4.0F, -11.0F, 0.5236F, 0.0F, 0.0F));

		PartDefinition mouth = Head.addOrReplaceChild("mouth", CubeListBuilder.create().texOffs(32, 62).addBox(-2.0F,
		...
		PartDefinition Neck = partdefinition.addOrReplaceChild("Neck",
				CubeListBuilder.create().texOffs(0, 32)
						...
						.addBox(-2.0F, -11.0F, -1.0F, 4.0F, 12.0F, 5.0F, new CubeDeformation(0.1F)).texOffs(64, 0)
						.addBox(-1.0F, -16.0F, 4.0F, 2.0F, 16.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(70, 33)
						.addBox(-1.0F, -18.0F, 1.0F, 2.0F, 2.0F, 5.0F, new CubeDeformation(0.0F)),
